<template>
  <div id="highlight" class="highlight border-t-1 border-grey">
        <div class="mx-16">
            ...
            <div class="flex mb-4 flex-wrap -mx-2"></div>
                    <!-- <transition-group name="fade" tag="div" class="flex mb-4 flex-wrap -mx-2"> -->
                        <div class="w-1/2 my-4 px-4" v-for="post in blogEntries" :key="post.id" v-scroll-reveal.reset>
...
export default {
  ...
  created () {
    setTimeout(() => { this.blogEntries = blogEntries }, 1000)
  }
}
</script>
