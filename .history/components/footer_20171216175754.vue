<template>
  <footer class="light">
        <div class="flex mx-8 justify-between items-start">
            ...
            <!-- <a href="https://github.com/zeit/" target="_blank" class="jsx-2536527884 github">
            ...
            <a href="https://twitter.com/zeithq" target="_blank" class="jsx-2536527884 bird">
