<template>
  <footer class="m-8">
        <div class="flex mx-8">
            ...
            <div class="">
                <a class="w-16 h-16" href="https://github.com/zeit/" target="_blank" class="jsx-2536527884 github">
                ...
                <a class="w-16 h-16" href="https://twitter.com/zeithq" target="_blank" class="jsx-2536527884 bird">
                ...
                <a href="mailto:team@zeit.co">team@zeit.co</a>
