    ...
    <div class="highlight border-t-1 border-grey">
        <div class="m-6">
            ...
            <div class="max-w-md w-full lg:flex -mx-2">
                <div class="h-48 lg:h-auto lg:w-48 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden w-" style="background-image: url('https://tailwindcss.com/img/card-left.jpg')" title="Woman holding a mug">
                </div>
