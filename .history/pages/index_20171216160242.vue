...
<div>
    ...
    <div class="highlight border-t-1 border-grey">
        <div class="m-6">
            <div class="flex justify-center w-full text-3xl m-6">
                Recent blog entries
            </div>
                ...
                <div class="flex -mx-2">
                    <div class="w-1/2 px-2">
                        <div class="max-w-md w-full lg:flex">
                            <div class="h-48 lg:h-auto flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden" style="background-image: url('https://tailwindcss.com/img/card-left.jpg')" title="Woman holding a mug">
                            </div>
